...
Dendrite Growth simulations using Deep Ritz Split method.
...
pip install -U "jax[cuda12]==0.8.2" equinox h5py jaxtyping matplotlib optax tqdm ipykernel ipywidgets jupyterlab --no-cache-dir
```
...
<!-- ``` -->
<!-- cd existing_repo -->
<!-- git remote add origin https://gitlab.univ-lorraine.fr/p05698/deepsplitting.git -->
<!-- git branch -M main -->
...
<!---->
<!-- - [ ] [Set up project integrations](https://gitlab.univ-lorraine.fr/p05698/deepsplitting/-/settings/integrations) -->
<!---->
